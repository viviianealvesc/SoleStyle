...
@section('content')
    ...
    <main class="pt-10">   
        <div class="flex items-center justify-between mr-2">
            <p class="uppercase text-white p-1 m-2 border-l-2 border-[#D9C549] font-semibold text-[0.90rem]">Tênis para corrida</p>
            <a class="text-[#D9C549] text-[0.90rem]" href="#">Ver todos ></a>
        </div>
        

        <div class="flex gap-1 mb-4 overflow-x-scroll px-1 [&::-webkit-scrollbar]:hidden">
        @if(isset($products))
